...
let displayBanner = async () => {
    await showBanner("Quiz", "You can choose number of MCQs, Category and difficulty level");
};
...
async function dataFetching(questions, category, difficultyConsole) {
...
async function startQuiz(data, questions) {
...
async function showResult(correctAnswer, userName, questionsNo, category, difficultyConsole) {
